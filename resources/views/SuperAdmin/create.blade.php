            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="card" style="width: 200%;">
                        <div style="padding:5%">
                            <form action="{{ route('superadmin.storeAdmin') }}" method="post" id="admin_form" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mt-3">
                                <button type="submit"
                                    class="text-white p-2 border-0 rounded px-3 fw-bold send_inquiry_btn btn btn-primary">Submit
                                  </button>
                            </div>
                    </div>
